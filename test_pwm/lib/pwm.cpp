...
void PWM::tournerADroite(){
	...
	while (i < 3000){
		...
		i+=1;
		_delay_ms(1); // A determiner avec le robot
...
* Retour : non
***********************************************************************************/
void PWM::ajustementReculerAGauche(){
	roueDroite(false, 50);
	roueGauche(false, 75);
}
...
* Retour : non
***********************************************************************************/
void PWM::ajustementReculerADroite(){
	roueDroite(false, 50);
	roueGauche(false, 25);
}
