/**************************************************************************************
* Titre: Travail pratique #1 - PWM.cpp
* Date: 12 mars 2018
* INF1995 - TP8
* Auteurs : LUU Kim 1834378, MELLOUK Souhaila 1835144, CHEBILI Meziane 1899977, CHICOINE Julien 1901439
**************************************************************************************/
#include "pwm.h"
...
void PWM::tournerADroite(){
	...
	_delay_ms(500); // A determiner avec le robot
